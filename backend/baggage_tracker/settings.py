"""
Django settings for baggage_tracker project.
...
SECRET_KEY = 'django-insecure-baggage-tracker-hackathon-secret-key-change-in-production'
...
ROOT_URLCONF = 'baggage_tracker.urls'
