          ...
          <p className="text-lg text-gray-600">
            {isAuthenticated
              ? `Welcome back${
                ...
                }! Track your baggage using the QR code or manual entry below.`
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6">
                Use your device camera to scan the QR code on your baggage tag
              </p>
          ...
          <div className="bg-white rounded-lg shadow-md p-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6">
                Enter your tracking code manually if you can&apos;t scan
              </p>
            ...
            <div className="p-6">
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                  ...
                  <p className="font-semibold text-gray-900">
                    {baggage.flight_number || "N/A"}
                  </p>
                </div>
                <div>
                  <p className="text-sm text-gray-500 mb-1">Destination</p>
                  <p className="font-semibold text-gray-900">
                    {baggage.destination || "N/A"}
                  </p>
                </div>
                <div>
              ...
              {/* Status Timeline */}
              {baggage.status_timeline &&
                baggage.status_timeline.length > 0 && (
                  <div>
